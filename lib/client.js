	...
	factory: (require) => {
		...
		* and never on the stop button (running turns render a square <rect>; the send arrow is a <path>). */
		...
		var CSS = [
			...
			".dsh-pg-hheader{box-sizing:border-box;width:100%;height:34px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:none;border-radius:8px;align-items:center;gap:10px;padding:4px 12px;display:flex}",
			...
			".dsh-pg-hchevron{width:14px;height:14px;color:var(--dsw-alias-label-tertiary);flex:none;place-items:center;display:grid}",
			...
			".dsh-pg-hlist{max-height:200px;overflow-y:auto;flex-direction:column;display:flex;gap:4px}",
			".dsh-pg-hrow{box-sizing:border-box;border-radius:8px;align-items:center;gap:8px;width:100%;min-height:36px;padding:4px 6px 4px 10px;display:flex}",
			".dsh-pg-hrow+.dsh-pg-hrow{box-shadow:inset 0 1px 0 var(--dsw-alias-border-l1)}",
			".dsh-pg-hidx{width:20px;height:20px;flex:none;place-items:center;display:grid;border-radius:50%;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:20px}",
			...
			".dsh-pg-hmeta{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:15px}",
			".dsh-pg-hedit{min-width:0;flex:1;font:inherit;font-size:13px;line-height:19px;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-module-platform);border:1px solid var(--dsw-alias-border-l2);border-radius:6px;padding:3px 8px}",
			".dsh-pg-hedit:focus{outline:none;border-color:var(--dsw-alias-state-warn-primary)}",
			".dsh-pg-hactions{flex:none;align-items:center;gap:2px;display:flex}",
			".dsh-pg-hact{width:26px;height:26px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:6px;place-items:center;padding:0;display:grid}",
			...
			".dsh-pg-hempty{padding:10px 12px;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:18px}",
			".dsh-pg-hfooter{flex:none;display:flex;justify-content:flex-end}",
			".dsh-pg-hclear{height:26px;font:inherit;font-size:12px;line-height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:6px;padding:0 8px}",
		...
		*/
		...
		/** Session dock window: the pending-send queue with reorder / edit / remove controls. */
		function HoldQueueDock({ t, gateStore: gate, useSessions }) {
			...
			return createElement(
				...
				expanded &&
					createElement(
						...
						holds.length === 0
							? createElement("div", { className: "dsh-pg-hempty" }, t("dock.empty"))
