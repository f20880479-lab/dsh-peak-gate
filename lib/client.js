	...
	factory: (require) => {
		...
		* Returns true when the send was handed to the composer. */
		...
		var en = {
			...
			"dock.resetPos": "Reset to default position",
			"dock.open": "Open send queue",
			"dock.collapse": "Collapse",
			"dock.resizeHint": "Drag the corner to resize",
		...
		* Defaults to the current session's entries; a toolbar toggle shows every session. */
		function HoldQueueDock({ t, gateStore: gate, ctx, useSessions, sessionId }) {
			...
			* by reading the live rect at pointerdown; on finish the panel switches to left/top. */
			...
			return createElement(
				"div",
				{ className: "dsh-pg-wrap", "data-dsh-hold-dock": "", style: wrapStyle },
				createElement(
					"div",
					...
					createElement(
						...
						createElement(
							...
							createElement(
								"button",
								{ type: "button", className: "dsh-pg-hact", "aria-label": t("dock.resetPos"), title: t("dock.resetPos"), onClick: resetPosition },
								createElement("svg", { viewBox: "0 0 16 16", width: "13", height: "13", fill: "none", stroke: "currentColor", strokeWidth: "1.4", strokeLinecap: "round", strokeLinejoin: "round", "aria-hidden": true }, createElement("path", { d: "M13.5 8a5.5 5.5 0 1 1-1.6-3.9M13.5 1.5v3h-3" }))
							)
						)
					),
					holds.length === 0
